...
def my_function(title: str, x: int, y: int) -> str:
    ...
    :param y: Deuxième élément de la chaine de caracère résultat
    :return: La chaine de caractère résultat composée du titre,
             suivi de deux retours à la ligne, suivi de x et y séparés par un espace
